                                ...
                                <div className="p-4 space-y-4 overflow-y-auto h-full">
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-300 mb-2">There are a few items on the tasklist that needs to be addressed on iOS.</p>
                                            <div className="bg-gray-800 rounded-lg p-3 text-sm">
                                                ...
                                                <p className="text-gray-400 text-xs">The 2nd level comment block does not highlight the follow up button.</p>
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-300 mb-2">
                                                Awesome! Make sure it looks as close to the Figma as possible :) Here's a link to our Figma file if you don't have access yet.
                                            </p>
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-300">Got it, I'll review the Figma file and make the necessary adjustments.</p>
                                        </div>
                                    </div>
                                    <div className="flex space-x-3">
                                        <div className="w-8 h-8 bg-gray-600 rounded-full"></div>
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-300">Thanks, Landon! That would be great. Let's sync up later today.</p>
                                        </div>
                                    </div>
                                </div>
