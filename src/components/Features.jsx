...
const toolIcons = [
    {
        name: "Linear",
        icon: (
            <img className="w-6 h-6 object-contain invert" alt="Linear icon" src="/src/utils/images/ball.png" onError={(e) => (e.target.src = "https://via.placeholder.com/24/FFFFFF/000000?text=L")} />
        ),
    },
    {
        name: "GitHub",
    ...
    },
    {
        name: "Cloud",
        icon: (
            <img className="w-6 h-6 object-contain invert" alt="Cloud icon" src="/src/utils/images/cloud.png" onError={(e) => (e.target.src = "https://via.placeholder.com/24/FFFFFF/000000?text=C")} />
        ),
    },
    {
        name: "Postman",
        icon: (
            <img className="w-6 h-6 object-contain invert" alt="Postman icon" src="/src/utils/images/unk.png" onError={(e) => (e.target.src = "https://via.placeholder.com/24/FFFFFF/000000?text=P")} />
        ),
    },
    {
        name: "Notion",
        icon: (
            <img
                className="w-6 h-6 object-contain invert"
                alt="Notion icon"
                src="/src/utils/images/prism.png"
    ...
    },
    {
        name: "Google",
        icon: (
            <img className="w-6 h-6 object-contain invert" alt="Google icon" src="/src/utils/images/goog.png" onError={(e) => (e.target.src = "https://via.placeholder.com/24/FFFFFF/000000?text=G")} />
        ),
    },
    {
        name: "Railway",
    ...
    },
    {
        name: "Figma",
        icon: (
            <img className="w-6 h-6 object-contain invert" alt="Figma icon" src="/src/utils/images/figm.png" onError={(e) => (e.target.src = "https://via.placeholder.com/24/FFFFFF/000000?text=F")} />
        ),
    },
]
                ...
                <div className="relative w-full h-[156px]">
                    <div className="relative w-[380px] h-[107px]">
                        ...
                        <div className="flex flex-col w-[380px] items-start gap-[7px] mt-[37px]">
                            <div className="relative self-stretch  font-semibold text-[#e2e8ff] text-[18.7px] tracking-[0] leading-normal">Collaborate on everything.</div>
            ...
            <div className="w-[570px] h-[353px] mx-auto mt-2 bg-[#0c0c26] rounded-[16.7px] overflow-hidden border-solid border border-[#2f2f49]">
                <div className="p-0 relative">
                    ...
                    <div className="relative w-full h-[366px]">
                        {/* Code editor image */}
                        <img className="w-[521px] h-[259px] absolute top-0 right-0 object-cover" alt="Code editor" src="https://c.animaapp.com/mblreywe5sjw5i/img/image-40.png" />
                        ...
                        {userCursors.map((user, index) => (
                            ...
                            >
                                <div className="relative h-full">
                                    ...
                                    >
                                        <div className="relative w-fit mt-[-1.00px] font-medium text-[#ced2e8] text-sm tracking-[0] leading-normal">{user.name}</div>
                                    </div>
                        ...
                        <div className="absolute w-full h-[94px] bottom-0 left-0 shadow-[0px_0px_4px_#00000040]">
                            <div className="relative w-full h-[94px] rounded-[8px_8px_15px_15px] border-solid border border-[#2f2f49] bg-[#0d0d27] bg-opacity-80">
                                <div className="flex items-end gap-1.5 absolute top-[23px] left-[163px]">
                                    <img className="relative w-[21px] h-5" alt="Frame" src="https://c.animaapp.com/mblreywe5sjw5i/img/frame-1.svg" />

                                    <div className="relative w-fit font-semibold text-white text-base tracking-[0.48px] leading-normal whitespace-nowrap">Collaborative debugging.</div>
                                </div>

                                <div className="absolute top-[46px] left-[116px] font-medium text-[#7a7d96] text-sm tracking-[0] leading-normal">Share and collaboratively debug code - together.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-[7px]">
                            ...
                            <p className="font-medium text-[#7c7f99] text-base">Connect your tools - we'll handle the rest. Many integrations, with more to come.</p>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full h-[359px] mt-4 rounded-[10.15px] overflow-hidden border-[#1c1d36] border">
                        <div className="absolute w-full h-full flex items-center justify-center central-anim">
                            ...
                            <div className="w-16 h-16 bg-gradient-to-br rounded-full flex items-center justify-center z-10">
                                <img className="w-[38px] h-[38px] object-cover" alt="Dimension logo" src="https://c.animaapp.com/mblreywe5sjw5i/img/q-715f17d1-2-2.png" />
                            </div>
        ...
        <section className="py-20 px-6 bg-gray-900">
            <div className="max-w-6xl mx-auto">
                <h3 className="text-white mb-0 text-[48px] font-semibold">
                    Build software <span className="bg-[linear-gradient(90deg,_#FFAC87_49.52%,_#FFDAA5_100%)] bg-clip-text text-transparent">faster, together.</span>
                </h3>
